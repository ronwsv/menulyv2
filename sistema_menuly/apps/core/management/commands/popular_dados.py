...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Criar cliente de teste (não vinculado ao User)
        ...
        cliente, created = Cliente.objects.get_or_create(
            ...
            defaults={
                ...
                'endereco_numero': '789',
                'endereco_bairro': 'Vila Cliente',
                'endereco_cidade': 'São Paulo',
                'endereco_estado': 'SP',
                'endereco_cep': '01234-999',
            }
        )
        if created:
            self.stdout.write('✓ Cliente de exemplo criado: Maria Santos')
        ...
        self.stdout.write('  • Cliente exemplo: Maria Santos (para checkout)')
